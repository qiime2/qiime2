    ...
    def test_actions(self):
        ...
        self.assertEqual(actions.keys(),
                         {'merge_mappings', 'concatenate_ints', 'split_ints',
                          ...
                          'deprecated_method', 'migrated_method1',
                          'migrated_method2', 'migrated_method3',
                          'migrated_method4', 'migrated_method5',
                          'migrated_method6', 'migrated_method7',
                          'migrated_method8', 'union_inputs',
                          'unioned_primitives',
