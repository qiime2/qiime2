...
# permissions we just create a directory.
STICKY_PERMISSIONS = stat.S_ISVTX | stat.S_IRWXU | stat.S_IRWXG | stat.S_IRWXO
...
def _get_temp_path():
    ...
    if not os.path.exists(cache_dir):
        try:
            os.mkdir(cache_dir, mode=STICKY_PERMISSIONS)
