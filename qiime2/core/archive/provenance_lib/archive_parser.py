...
from .util import get_root_uuid, get_nonroot_uuid, FileName, parse_version
...
class ParserV0(ArchiveParser):
    ...
    def _parse_root_md(self, zf: zipfile.ZipFile, root_uuid: str) \
            -> _ResultMetadata:
    ...
    def _digraph_from_archive_contents(
            self, archive_contents: Dict[str, 'ProvNode']) -> nx.DiGraph:
        """
        ...
        with zipfile.ZipFile(archive_data) as zf:
            ...
            for fp in prov_data_fps:
                ...
                if node_uuid not in archv_contents:
                    ...
                    v_fp = prefix / 'VERSION'
                    result_vzn, _ = parse_version(zf, v_fp)
                    exp_files = \
