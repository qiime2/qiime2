...
class TestArchiver(unittest.TestCase, ArchiveTestingMixin):
    ...
    def test_load_dotfile_only_archive(self):
        ...
        with zipfile.ZipFile(fp, mode="r") as zf:
            expected = {".DS_Store", ".hidden-file", ".hidden-dir/ignored-file"}
    ...
    def test_load_invalid_uuid4_root_dir(self):
        ...
        with self.assertRaisesRegex(ValueError, "root directory.*valid version 4 UUID"):
            _ZipArchive(zp)
    ...
    def test_parse_uuid_invalid(self):
        ...
        for uuid_ in (
            uuid.uuid1(),
            uuid.uuid3(uuid.NAMESPACE_DNS, "foo"),
    ...
    def test_checksums_mismatch(self):
        ...
        self.assertEqual(diff.added, {"tamper.txt": "296583001b00d2b811b5871b19e0ad28"})
    ...
    def test_archive_check(self):
        ...
        expected = set(
            ["metadata.yaml", "data", "checksums.md5", "provenance", "VERSION"]
        )
