...
from .visualizer import most_common_viz, mapping_viz, params_only_viz, no_input_viz
...
dummy_plugin.register_semantic_types(
    IntSequence1,
    IntSequence2,
    IntSequence3,
    Mapping,
...
dummy_plugin.register_semantic_type_to_format(
    IntSequence3, directory_format=IntSequenceMultiFileDirectoryFormat
)
dummy_plugin.register_semantic_type_to_format(
    Mapping, directory_format=MappingDirectoryFormat
)
dummy_plugin.register_semantic_type_to_format(
    FourInts, directory_format=FourIntsDirectoryFormat
)
dummy_plugin.register_semantic_type_to_format(
    SingleInt, directory_format=RedundantSingleIntDirectoryFormat
)
dummy_plugin.register_semantic_type_to_format(
    Kennel[Dog | Cat], directory_format=MappingDirectoryFormat
)
...
dummy_plugin.register_semantic_type_to_format(
    AscIntSequence, directory_format=IntSequenceDirectoryFormat
)

dummy_plugin.register_semantic_type_to_format(
    Squid | Octopus | Cuttlefish, directory_format=CephalapodDirectoryFormat
)
...
dummy_plugin.methods.register_function(
    ...
    citations=[citations["witcombe2006sword"], citations["reimers2012response"]],
)
...
dummy_plugin.methods.register_function(
    ...
    inputs={"mapping1": Mapping},
    input_descriptions={
        "mapping1": (
            "This is a very long description. If asked about its "
    ...
    parameter_descriptions={
        "name": (
            "This is a very long description. If asked about its length,"
...
dummy_plugin.methods.register_function(
    ...
    inputs={"req_input": Mapping, "opt_input": Mapping},
    input_descriptions={
        "req_input": "This should show up first.",
        "opt_input": "This should show up third.",
    },
    parameters={"req_param": Str, "opt_param": Int},
    parameter_descriptions={
        "req_param": "This should show up second.",
        "opt_param": "This should show up fourth.",
    },
    outputs=[("out", Mapping)],
    output_descriptions={"out": "This should show up last, in it's own section."},
...
dummy_plugin.methods.register_function(
    ...
    examples={
        "identity_with_metadata_column_get_mdc": identity_with_metadata_column_get_mdc,
    },
)
...
dummy_plugin.methods.register_function(
    ...
    outputs=[("out", IntSequence1)],
    name="Identity",
    description="This method does nothing, but takes a categorical metadata " "column",
)
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": List[IntSequence1 | IntSequence2], "int_set": Set[SingleInt]},
    parameters={"nums": Set[Int], "opt_nums": List[Int % Range(10, 20)]},
    outputs=[("output", IntSequence1)],
    ...
    output_descriptions={"output": "All of the above mashed together"},
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": T},
    parameters={"strs1": List[Str], "strs2": Set[Str]},
    outputs=[("output", T)],
    name="TypeMatch with list and set params",
    description="Just a method with a TypeMatch and list/set params",
    input_descriptions={"ints": "An int artifact"},
    parameter_descriptions={"strs1": "A list of strings", "strs2": "A set of strings"},
    output_descriptions={"output": "[0]"},
)

dummy_plugin.visualizers.register_function(
    function=params_only_viz,
    inputs={},
    parameters={"name": Str, "age": Int % Range(0, None)},
...
dummy_plugin.visualizers.register_function(
    ...
    inputs={"mapping1": Mapping, "mapping2": Mapping},
    parameters={"key_label": Str, "value_label": Str},
...
dummy_plugin.pipelines.register_function(
    ...
    inputs={},
    parameters={"int1": Int, "int2": Int, "metadata": Metadata, "other": Bool},
    outputs=[("foo", IntSequence2), ("bar", IntSequence1)],
...
dummy_plugin.pipelines.register_function(
    ...
    inputs={"int_sequence": IntSequence1, "mapping": Mapping},
    parameters={"do_extra_thing": Bool, "add": Int},
    outputs=[
        ("out_map", Mapping),
        ("left", IntSequence1),
        ("right", IntSequence1),
    ...
    examples={
        "typical_pipeline_simple": typical_pipeline_simple,
...
dummy_plugin.pipelines.register_function(
    ...
    inputs={"int_sequence": IntSequence1, "single_int": SingleInt},
    parameters={},
    outputs=[("ints", IntSequence1)],
    input_descriptions={"int_sequence": "Some integers", "single_int": "An integer"},
    output_descriptions={"ints": "More integers"},
...
dummy_plugin.pipelines.register_function(
    ...
    parameters={},
    outputs=[("viz1", Visualization), ("viz2", Visualization)],
    input_descriptions={"mapping": "A mapping to look at twice"},
    output_descriptions={
...
dummy_plugin.pipelines.register_function(
    ...
    description=(
        "Mapping is chained from typical_pipeline into " "visualizer_only_pipeline"
    ),
)
...
dummy_plugin.pipelines.register_function(
    ...
    name="To be resumed",
    description=(
        "Called first with fail=True then again with fail=False "
...
dummy_plugin.pipelines.register_function(
    ...
    description=(
        "This pipeline is called inside of "
...
dummy_plugin.pipelines.register_function(
    ...
    description=(
        "This pipeline is supposed to be run in parallel and fail "
...
dummy_plugin.pipelines.register_function(
    ...
    inputs={"int_sequence": IntSequence1},
    parameters={
        "break_from": Str
        % Choices(
            {
    ...
    description=(
        "This is useful to make sure all of the intermediate stuff is"
...
dummy_plugin.pipelines.register_function(
    ...
    parameters={},
    outputs=[("visualizations", Collection[Visualization])],
...
dummy_plugin.methods.register_function(
    ...
    input_descriptions={"ints1": "An int artifact", "ints2": "An int artifact"},
    output_descriptions={
        "ints": "[0]",
    },
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": List[SingleInt]},
    parameters={},
    outputs=[("output", Collection[SingleInt])],
    name="Reverses list of inputs",
    description="Some description",
    input_descriptions={"ints": "Collection of ints"},
    output_descriptions={"output": "Reversed Collection of ints"},
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": Collection[SingleInt]},
    parameters={},
    outputs=[("output", Collection[SingleInt])],
    name="Takes ints",
    description="Some description",
    input_descriptions={"ints": "Collection of ints"},
    output_descriptions={"output": "Collection of ints"},
    examples={
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": Collection[IntSequence1 | IntSequence2]},
    parameters={},
...
dummy_plugin.methods.register_function(
    ...
    inputs={"ints": Collection[IntSequence1] | Collection[IntSequence2]},
    parameters={},
    outputs=[("output", Collection[IntSequence1])],
    name="Takes ints",
    description="Some description",
...
dummy_plugin.methods.register_function(
    ...
    description="Takes and returns a combination of colletions and non" " collections",
)
