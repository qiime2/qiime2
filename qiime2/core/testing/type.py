...
C2 = plugin.SemanticType(
    "C2",
    field_names=["first", "second"],
    variant_of=C1.field["first"],
    field_members={"first": [C1], "second": [C1]},
)
C3 = plugin.SemanticType(
    "C3",
    field_names=["first", "second", "third"],
    variant_of=[C1.field["first"], C2.field["first"], C2.field["second"]],
    field_members={"first": [C1, C2], "second": [C1, C2], "third": [C1, C2]},
)
_variants = [
    C1.field["first"],
    C2.field["first"],
