...
class TestVisualizer(unittest.TestCase, ArchiveTestingMixin):
    ...
    def test_private_constructor(self):
        with self.assertRaisesRegex(
            NotImplementedError, "Visualizer constructor.*private"
        ):
            Visualizer()
    ...
    def test_from_function_with_artifacts_and_parameters(self):
        ...
        self.assertTrue(
            visualizer.description.startswith(
                "This visualizer produces an " "HTML visualization"
            )
        )
    ...
    def test_from_function_without_parameters(self):
        ...
        exp_sig = VisualizerSignature(
            most_common_viz, inputs={"ints": IntSequence1 | IntSequence2}, parameters={}
        )
        self.assertEqual(visualizer.signature, exp_sig)
        ...
        self.assertTrue(
            visualizer.description.startswith(
                "This visualizer produces HTML " "and TSV"
            )
        )
        self.assertTrue(
    ...
    def test_from_function_without_inputs_or_parameters(self):
        ...
        self.assertTrue(
            visualizer.description.startswith("This visualizer does not " "accept any")
        )
        self.assertTrue(visualizer.source.startswith("\n```python\ndef no_input_viz("))
    ...
    def test_callable_properties(self):
        ...
        mapper = {mapping_viz: mapping_exp, most_common_viz: most_common_exp}
    ...
    def test_callable_and_async_signature(self):
        ...
        for callable_attr in "__call__", "asynchronous":
            ...
            exp_parameters = [
                ...
                ("key_label", inspect.Parameter("key_label", kind, annotation=Str)),
                ("value_label", inspect.Parameter("value_label", kind, annotation=Str)),
            ]
    ...
    def test_call_with_artifacts_and_parameters(self):
        ...
        artifact2 = Artifact.import_data(Mapping, {"baz": "abc", "bazz": "ghi"})
    ...
    def test_call_with_no_parameters(self):
        ...
        artifact = Artifact.import_data(IntSequence1, [42, 42, 10, 0, 42, 5, 0])
