...
from qiime2.core.testing.visualizer import mapping_viz, most_common_viz, multi_html_viz
...
class TestVisualization(unittest.TestCase, ArchiveTestingMixin):
    ...
    def test_load_with_archive_filepath_modified(self):
        ...
        Visualization._from_data_dir(new_data_dir, self.make_provenance_capture()).save(
            fp
        )
        visualization2 = Visualization.load(fp)

        self.assertEqual(visualization1.get_index_paths(), {"html": "data/index.html"})
        self.assertEqual(
            visualization2.get_index_paths(),
    ...
    def test_get_index_paths_relative_false(self):
        ...
        expected = {
            "html": get_abs_path("data/index.html"),
