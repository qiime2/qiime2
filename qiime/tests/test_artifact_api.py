...
class TestImports(unittest.TestCase):
    ...
    def _check_plugin(self, module):
        self._check_spec(module, 'qiime.plugin.dummy_plugin', True)
    ...
    def _check_methods(self, module):
        self._check_spec(module, 'qiime.plugin.dummy_plugin.methods', False)
        ...
        self.assertIsInstance(module.concatenate_ints, qiime.sdk.Method)
        self.assertIsInstance(module.concatenate_ints_markdown,
                              qiime.sdk.Method)

    def _check_visualizers(self, module):
        self._check_spec(
            module, 'qiime.plugin.dummy_plugin.visualizers', False)
        ...
        self.assertIsInstance(module.most_common_viz, qiime.sdk.Visualizer)

    def test_import_root(self):
        import qiime.plugin.dummy_plugin
        self._check_plugin(qiime.plugin.dummy_plugin)

    def test_import_root_from(self):
        from qiime.plugin import dummy_plugin
        self._check_plugin(dummy_plugin)

    def test_import_methods(self):
        import qiime.plugin.dummy_plugin.methods
        self._check_methods(qiime.plugin.dummy_plugin.methods)

    def test_import_visualizers(self):
        import qiime.plugin.dummy_plugin.visualizers
        self._check_visualizers(qiime.plugin.dummy_plugin.visualizers)

    def test_import_methods_from(self):
        from qiime.plugin.dummy_plugin import methods
        self._check_methods(methods)

    def test_import_visualizers_from(self):
        from qiime.plugin.dummy_plugin import visualizers
        self._check_visualizers(visualizers)

    def test_import_non_plugin(self):
        with self.assertRaises(ImportError):
            import qiime.plugin.dummy_not_plugin  # noqa

    def test_import_non_action(self):
        with self.assertRaises(ImportError):
            import qiime.plugin.dummy_plugin.non_action  # noqa
    ...
    def test_import_side_module(self):
        ...
        with self.assertRaises(ImportError):
            import qiime.plugin.metadata  # noqa

    def test_import_too_deep(self):
        with self.assertRaises(ImportError):
            import qiime.plugin.dummy_plugin.methods.too_deep  # noqa

    def test_import_non_module(self):
        with self.assertRaises(ImportError):
            import qiime.plugin.dummy_plugin.methods.concatenate_ints  # noqa

    def test_reload_fails(self):
        import qiime.plugin.dummy_plugin
        with self.assertRaises(ImportError):
            importlib.reload(qiime.plugin.dummy_plugin)
